...
func _zoom() -> void:
	...
	tween.tween_property(self, "zoom", current_zoom * 1.09, 0.1)
	tween.tween_property(self, "zoom", current_zoom * 0.92, 0.2)
	tween.tween_property(self, "zoom", current_zoom, 0.1)
